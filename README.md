...
<ul>
  ...
  <li>🌗 מצב Light / Dark עם שמירה אוטומטית</li>
  <li>🌓 כפתור ☀️ / 🌙 בראש הממשק</li>
  <li>💾 טעינה ושמירה של כל ההגדרות האחרונות</li>
  <li>🔄 Undo / Redo עם היסטוריה מלאה</li>
  <li>🧠 טיפול חכם בכפילויות</li>
  <li>👀 ניטור תיקיות בזמן אמת (watchdog)</li>
</ul>
